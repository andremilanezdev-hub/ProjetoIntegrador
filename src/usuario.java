...
public class usuario {
           ...
           do {
               ...
               switch (opcao){
                   ...
                   case 4:
                       ...
                       System.out.print("Informe o ID do Usuário que irá alterar: ");
                       idUser = sc.nextInt();
                       sc.nextLine();
                       System.out.print("Informe a nova senha: ");
                       senha = sc.nextLine();

                       boolean alt = conexao_banco.deletar("UPDATE usuarios SET senha = ? WHERE id = ?;",senha, idUser);
                       if (alt) {
    ...
    private static boolean verifica(String login, String nome) {
        String sql = "SELECT id FROM usuarios WHERE login = ? OR nome = ?";
